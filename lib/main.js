...
class Template extends EventEmitter {
  ...
  updateDescriptor(descriptor, overlay = "tman") {
    ...
    const myDescriptor = this.foglet.overlay(overlay)._network._rps.options.descriptor;
    ...
    this.foglet.overlay(overlay).network._rps.parent.getPeers().forEach(peerId => {
      this.sendOverlayUnicast(peerId, new MUpdatePartialView(this.foglet.inViewID, myDescriptor))
    });
